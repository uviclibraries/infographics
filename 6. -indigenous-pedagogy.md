...
2. Start editing the template and make the title: <img src="images/IndigenousLearningDesignRename.png" style="float:right;width:200px; margin-right:10px;" alt="Title">  
...
7. Add a totem image and resize it. 
  ...
  - The image attribution for the totem is cut off, so we will replace it:  
    - Make a new text box with an image attribution: **Totem by Hey Rabbit from NounProject.com - CC-BY** Place at the bottom of your infographic with a small but readable text size.
